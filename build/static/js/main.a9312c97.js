/*! For license information please see main.a9312c97.js.LICENSE.txt */
...
`,_e=Zr.div`
  ...
  color: var(--text-light);
  font-size: 0.9rem;
`;return(0,Gs.jsxs)(nd,{"data-testid":"comment-section",style:{paddingBottom:be?"300px":"0",transition:"padding-bottom 0.3s ease"},"aria-live":"polite","aria-atomic":"true",children:[(0,Gs.jsxs)(Ad,{"aria-live":"polite",children:[a.length," ",1===a.length?"coment\xe1rio":"coment\xe1rios"]}),c&&(0,Gs.jsxs)(Rd,{role:"alert",children:[c,(0,Gs.jsx)(we,{onClick:re,"aria-label":"Tentar carregar coment\xe1rios novamente",children:"Tentar novamente"})]}),(0,Gs.jsx)(rd,{ref:Y,$keyboardHeight:V,$keyboardActive:be,children:l?(0,Gs.jsxs)(Td,{"aria-busy":"true",children:[(0,Gs.jsx)("div",{className:"spinner","aria-hidden":"true"}),"Carregando coment\xe1rios..."]}):Array.isArray(a)&&0!==a.length?(0,Gs.jsxs)("div",{role:"list",children:[ve.map((e=>(0,Gs.jsx)(Gd,{comment:e,depth:0,currentUser:i,onEdit:pe,onDelete:me,onReply:ce,onReaction:ge,editingId:h,editText:g,onEditChange:v,onSaveEdit:he,replyingTo:R,replyTexts:A,onReplyChange:de,onReplySubmit:fe,showOptions:y,onToggleOptions:b,isPopular:e.isPopular||!1,onReplyMediaChange:ie,onReplyMemeChange:ae,replyMedia:$,replySelectedMeme:z,onOpenMemeSelector:se,userMemes:S,loadMoreReplies:Z,loadingReplies:H,expandedReplies:F,setExpandedReplies:U},e._id))),ye&&a.length>3&&(0,Gs.jsx)(_e,{children:"Voc\xea chegou ao fim. Role para cima \u2191"})]}):(0,Gs.jsxs)(Od,{children:["Nenhum coment\xe1rio ainda. Seja o primeiro!",ye&&(0,Gs.jsx)("div",{style:{marginTop:"10px"},children:"Role para baixo para comentar \u2193"})]})}),i&&(0,Gs.jsxs)(Gs.Fragment,{children:[(0,Gs.jsxs)(fd,{onSubmit:ue,role:"form",ref:Q,$keyboardActive:be,$keyboardHeight:V,children:[(0,Gs.jsx)(pd,{type:"text",id:"main-comment-input",name:"mainComment",value:f,onChange:e=>p(e.target.value),placeholder:"Escreva um coment\xe1rio...","aria-label":"Escrever coment\xe1rio","data-testid":"comment-input","aria-required":"true"}),(0,Gs.jsxs)(Md,{children:[(0,Gs.jsx)(Dd,{type:"button",onClick:()=>document.getElementById("comment-file-input").click(),"aria-label":"Anexar m\xeddia","data-testid":"attach-media-button",children:(0,Gs.jsx)(uu,{size:18,"aria-hidden":"true"})}),(0,Gs.jsx)("input",{type:"file",id:"comment-file-input",style:{display:"none"},onChange:oe,accept:"image/*, video/*","data-testid":"media-input","aria-label":"Selecionar arquivo de m\xeddia"}),(0,Gs.jsx)(Dd,{type:"button",onClick:()=>{k(!0),ne()},"aria-label":"Compartilhar meme","data-testid":"meme-selector-button",children:(0,Gs.jsx)(tu,{size:18,"aria-hidden":"true"})}),(0,Gs.jsx)(hd,{type:"submit","aria-label":"Enviar coment\xe1rio",disabled:!f.trim()&&!T&&!j,"data-testid":"submit-comment-button","aria-disabled":!f.trim()&&!T&&!j,children:(0,Gs.jsx)(pu,{size:18,"aria-hidden":"true"})})]}),(T||j)&&(0,Gs.jsx)(Jd,{file:T,meme:j?S.find((e=>e._id===j)):null,onRemove:()=>{O(null),C(null)},"data-testid":"media-preview"})]}),_&&(0,Gs.jsx)(Zd,{memes:S,selectedMeme:D?z[D]:j,onSelect:le,onClose:()=>{k(!1),I(null)},isForReply:!!D,"data-testid":"meme-selector-modal"})]})]})},tf=(e,t,n)=>{if(!e)return null;return e.split(/(@\w+)/g).map(((e,r)=>{if(e.startsWith("@")){const o=e.substring(1),i=t[o];return i?(0,Gs.jsx)("span",{className:"mention",onClick:e=>{e.preventDefault(),e.stopPropagation(),n(`/users/${i}`)},children:e},`${o}-${r}`):e}return e}))},nf=async e=>{if(!e)return[];const t=[...e.matchAll(/@([a-zA-Z0-9_]+)/g)],n=[...new Set(t.map((e=>e[1])))];if(0===n.length)return[];try{const e=await wa.post("/users/validate-mentions",{usernames:n}),t={};return e.data.validUsers.forEach((e=>{t[e.username]=e.userId})),{mentions:e.data.validUsers,mentionMap:t}}catch(r){return console.error("Error validating mentions:",r),{mentions:[],mentionMap:{}}}},rf=to`
...
//# sourceMappingURL=main.a9312c97.js.map