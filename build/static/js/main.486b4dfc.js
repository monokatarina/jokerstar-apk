/*! For license information please see main.486b4dfc.js.LICENSE.txt */
...
`,ld=e=>{let{memeId:t,onDelete:r}=e;const[o,i]=(0,n.useState)(!1);return(0,Zs.jsxs)("div",{style:{position:"relative"},children:[(0,Zs.jsx)(id,{onClick:()=>i(!o),children:(0,Zs.jsx)(Cl,{size:14})}),o&&(0,Zs.jsx)(ad,{children:(0,Zs.jsxs)(sd,{onClick:async()=>{try{await wa.delete(`/memes/${t}`),r(t)}catch(Wv){console.error("Erro ao deletar meme:",Wv)}i(!1)},children:[(0,Zs.jsx)(Ll,{}),(0,Zs.jsx)("span",{children:"Deletar"})]})})]})},ud=Zn(nt)`
  display: block;
  border-radius: 8px;
  overflow: hidden;
  position: relative;
...
`,fp=()=>{const{user:e,loading:t,initialCheckDone:r}=rl(),n=te();return t||!r?null:(0,Zs.jsx)(dp,{onClick:()=>{!t&&r&&(e?n("/upload"):n("/login",{state:{from:"/upload"}}))},disabled:t,"aria-label":"Bot\xe3o de upload",children:(0,Zs.jsx)(iu,{})})},pp=Zn.div`
  width: 100%;
...
`,xp=()=>{const[e,t]=(0,n.useState)([]),[r,o]=(0,n.useState)(!0),[i,a]=(0,n.useState)(null),{user:s,logout:l}=rl(),u=te(),c=(0,n.useCallback)((async()=>{try{o(!0),a(null);const{data:e}=await wa.get("/feed/trending?limit=50");t(e.data)}catch(i){var e;console.error("Error fetching trending memes:",i),a("Erro ao carregar os memes em destaque. Tente novamente mais tarde."),401===(null===(e=i.response)||void 0===e?void 0:e.status)&&(await l(),u("/login"))}finally{o(!1)}}),[l,u]),d=(0,n.useCallback)((()=>{c()}),[c]);return(0,n.useEffect)((()=>{c()}),[c]),r?(0,Zs.jsx)(pp,{children:(0,Zs.jsx)(vp,{children:"Carregando memes em destaque..."})}):i?(0,Zs.jsx)(pp,{children:(0,Zs.jsxs)(yp,{children:[i,(0,Zs.jsxs)("button",{onClick:d,children:[(0,Zs.jsx)(au,{})," Tentar novamente"]})]})}):(0,Zs.jsx)(Zs.Fragment,{children:(0,Zs.jsx)(pp,{children:(0,Zs.jsx)(hp,{children:0===e.length?(0,Zs.jsxs)(gp,{children:[(0,Zs.jsx)("h3",{children:"Nenhum meme em destaque encontrado"}),(0,Zs.jsx)("p",{children:"Que tal criar o primeiro?"}),(0,Zs.jsx)(fp,{size:"large"})]}):e.map((e=>{var t;return(0,Zs.jsxs)(mp,{children:[(0,Zs.jsx)(cp,{meme:e,isSquareView:!1,style:{width:"100%",height:"100%"}}),s&&s._id!==(null===(t=e.author)||void 0===t?void 0:t._id)&&(0,Zs.jsxs)(bp,{onClick:()=>(async e=>{try{await wa.post(`/memes/${e}/repost`),c()}catch(i){var t;console.error("Erro ao repostar:",i),a("Erro ao repostar"),401===(null===(t=i.response)||void 0===t?void 0:t.status)&&(await l(),u("/login"))}})(e._id),children:[(0,Zs.jsx)("span",{children:"\ud83d\udd01"})," Repostar (",e.repostCount||0,")"]})]},e._id)}))})})})},wp=()=>{const{user:e}=rl();return e?(0,Zs.jsx)(xp,{}):(0,Zs.jsxs)("div",{children:[(0,Zs.jsx)("h1",{children:"Bem-vindo ao iFunny Clone"}),(0,Zs.jsx)("p",{children:"Fa\xe7a login para ver o conte\xfado"})]})},kp=Zn.div`
  display: flex;
  min-height: 100vh;
  background: var(--background);
  color: var(--text);
...
`,Op=()=>{const[e,t]=(0,n.useState)({usernameOrEmail:"",password:""}),[r,o]=(0,n.useState)(""),[i,a]=(0,n.useState)(!1),[s,l]=(0,n.useState)("0px"),{user:u,initialCheckDone:c,verifyAuth:d}=rl(),f=te(),p=G(),h=il.Ii.isNativePlatform();(0,n.useEffect)((()=>{if(h)return od.addListener("keyboardWillShow",(e=>{l(`${e.keyboardHeight}px`)})),od.addListener("keyboardWillHide",(()=>{l("0px")})),()=>{od.removeAllListeners()}}),[h]),(0,n.useEffect)((()=>{var e,t;c&&(u&&f((null===(e=p.state)||void 0===e||null===(t=e.from)||void 0===t?void 0:t.pathname)||"/feed",{replace:!0,state:{...p.state,isMobile:h}}))}),[u,c,f,p,h]);return(0,Zs.jsx)(kp,{style:{paddingBottom:s,transition:"padding-bottom 0.3s ease"},children:(0,Zs.jsxs)(_p,{children:[(0,Zs.jsx)(Cp,{children:"Bem-vindo de volta"}),r&&(0,Zs.jsx)(jp,{children:r}),(0,Zs.jsxs)("form",{onSubmit:async t=>{t.preventDefault(),a(!0),o("");try{var r,n;const t=await Sa(e);localStorage.setItem("token",t.token),Js(t.token),await d(),f((null===(r=p.state)||void 0===r||null===(n=r.from)||void 0===n?void 0:n.pathname)||"/trending",{replace:!0,state:{...p.state,isMobile:h}})}catch(Wv){o(Wv.message||"Credenciais inv\xe1lidas. Por favor, tente novamente."),localStorage.removeItem("token")}finally{a(!1)}},children:[(0,Zs.jsx)(Sp,{type:"text",placeholder:"Usu\xe1rio ou Email",value:e.usernameOrEmail,onChange:r=>t({...e,usernameOrEmail:r.target.value}),required:!0,autoCapitalize:"none"}),(0,Zs.jsx)(Sp,{type:"password",placeholder:"Senha",value:e.password,onChange:r=>t({...e,password:r.target.value}),required:!0}),(0,Zs.jsx)(Ep,{type:"submit",disabled:i,children:i?"Entrando...":"Entrar"})]}),(0,Zs.jsxs)(Tp,{children:["N\xe3o tem conta? ",(0,Zs.jsx)(nt,{to:"/register",state:{isMobile:h},children:"Cadastre-se"})]})]})})},Rp=Zn.div`
  display: flex;
  min-height: 100vh;
...
`,Mp=Zn.small`
  ...
  color: #7f8c8d;
  font-size: 0.8rem;
`,Ip=()=>{const[e,t]=(0,n.useState)({username:"",email:"",password:""}),[r,o]=(0,n.useState)(""),[i,a]=(0,n.useState)(!1),s=te();return(0,Zs.jsx)(Rp,{children:(0,Zs.jsxs)(Pp,{children:[(0,Zs.jsx)(zp,{children:"Crie sua conta"}),r&&(0,Zs.jsx)(Np,{children:r}),(0,Zs.jsxs)("form",{onSubmit:async t=>{t.preventDefault(),a(!0),o("");try{const t=await _a(e);localStorage.setItem("token",t.token),s("/feed",{replace:!0})}catch(Wv){o("CONFLICT"===Wv.type?Wv.message:"Erro ao cadastrar. Por favor, tente novamente.")}finally{a(!1)}},children:[(0,Zs.jsx)(Ap,{type:"text",placeholder:"Nome de usu\xe1rio",value:e.username,onChange:r=>t({...e,username:r.target.value}),required:!0,minLength:3}),(0,Zs.jsx)(Ap,{type:"email",placeholder:"Email",value:e.email,onChange:r=>t({...e,email:r.target.value}),required:!0}),(0,Zs.jsx)(Ap,{type:"password",placeholder:"Senha",value:e.password,onChange:r=>t({...e,password:r.target.value}),required:!0,minLength:6}),(0,Zs.jsx)(Mp,{children:"M\xednimo de 8 caracteres e numeros"}),(0,Zs.jsx)(Lp,{type:"submit",disabled:i,children:i?"Cadastrando...":"Criar conta"})]}),(0,Zs.jsxs)($p,{children:["J\xe1 tem conta? ",(0,Zs.jsx)(nt,{to:"/login",children:"Fa\xe7a login"})]})]})})},Dp=Zn.div`
  width: 100%;
  background-color: var(--background);
  -webkit-overflow-scrolling: touch;
  scroll-behavior: smooth;
...
`,Xp=Zn.img`
  ...
  border-radius: 50%;
  object-fit: cover;
`,Jp=e=>{let{value:t,onChange:r,placeholder:o}=e;const[i,a]=(0,n.useState)(!1),[s,l]=(0,n.useState)([]),[u,c]=(0,n.useState)(""),[d,f]=(0,n.useState)(0),p=(0,n.useRef)(null),h=async e=>{if(!e||e.length<1)a(!1);else try{const t=await wa.get("/users/search",{params:{q:e}});t.data&&t.data.success&&Array.isArray(t.data.data)?(l(t.data.data),a(t.data.data.length>0)):(l([]),a(!1))}catch(t){console.error("Error fetching mentions:",t),l([]),a(!1)}};return(0,n.useEffect)((()=>{const e=e=>{p.current&&!p.current.contains(e.target)&&a(!1)};return document.addEventListener("mousedown",e),()=>{document.removeEventListener("mousedown",e)}}),[]),(0,n.useEffect)((()=>{const e=e=>{"Escape"===e.key&&a(!1)};return document.addEventListener("keydown",e),()=>{document.removeEventListener("keydown",e)}}),[]),(0,Zs.jsxs)(Vp,{children:[(0,Zs.jsx)(Kp,{ref:p,value:t,onChange:e=>{const t=e.target.value;r(t);const n=e.target.selectionStart,o=t.substring(0,n),i=o.lastIndexOf("@");if(i>=0){const e=o.substring(i+1);if(/\w/.test(e)&&!/\s/.test(e)){const e=t.substring(i+1,n);return c(e),f(i),void(e.length>=1?(h(e),a(!0)):a(!1))}}a(!1)},placeholder:o,onClick:()=>a(!1)}),i&&s.length>0&&(0,Zs.jsx)(Yp,{children:s.map((e=>{var n,o;return(0,Zs.jsxs)(Qp,{onClick:()=>(e=>{console.log("Selecionando:",e,"Posi\xe7\xe3o:",d,"Query:",u);const n=t,o=n.substring(0,d),i=n.substring(d+u.length+1);r(`${o}@${e} ${i}`),a(!1),setTimeout((()=>{if(p.current){p.current.focus();const t=d+e.length+2;p.current.setSelectionRange(t,t)}}),0)})(e.username),children:[(0,Zs.jsx)(Xp,{src:null!==(n=e.profile)&&void 0!==n&&n.avatar?e.profile.avatar.startsWith("http")?e.profile.avatar:`${{NODE_ENV:"production",PUBLIC_URL:"",WDS_SOCKET_HOST:void 0,WDS_SOCKET_PATH:void 0,WDS_SOCKET_PORT:void 0,FAST_REFRESH:!0}.REACT_APP_API_URL||"https://api.jokesteronline.org"}${e.profile.avatar}`:"https://i.pravatar.cc/150?img=3",alt:e.username,crossOrigin:"anonymous",onError:e=>{e.target.src="https://i.pravatar.cc/150?img=3"}}),(0,Zs.jsxs)("span",{children:["@",e.username]}),(null===(o=e.profile)||void 0===o?void 0:o.displayName)&&(0,Zs.jsxs)("span",{style:{color:"var(--text-light)",fontSize:"0.9em"},children:["(",e.profile.displayName,")"]})]},e._id)}))})]})},Gp=Zn.div`
  max-width: 800px;
  margin: 2rem auto;
  padding: 2rem;
  background: var(--card-bg);
...
`,xh=e=>{var t,r;let{user:o,showFollowButton:i=!1}=e;const[a,s]=(0,n.useState)(!1),l=(()=>{if(null===o||void 0===o||!o.createdAt)return 0;try{const e=new Date(o.createdAt),t=new Date-e;return Math.max(1,Math.floor(t/864e5))}catch(e){return 1}})();return(0,Zs.jsxs)(fh,{children:[(0,Zs.jsxs)(yh,{days:l,children:[l>=365?(0,Zs.jsx)(Fl,{}):l>=180?(0,Zs.jsx)(du,{}):l>=30?(0,Zs.jsx)(wu,{}):(0,Zs.jsx)(Bl,{}),l,"d",(0,Zs.jsxs)(bh,{children:[(0,Zs.jsx)("div",{style:{fontWeight:"bold",marginBottom:"3px"},children:l>=365?"Veterano":l>=180?"Experiente":l>=30?"Membro Ativo":"Novato"}),(0,Zs.jsxs)("div",{style:{fontSize:"11px",color:"var(--text-light)"},children:["Na plataforma h\xe1 ",l," dia",1!==l?"s":""]}),(0,Zs.jsxs)("div",{style:{fontSize:"10px",marginTop:"5px",color:"var(--text-lighter)",borderTop:"1px solid var(--border)",paddingTop:"5px"},children:["Desde ",new Date(o.createdAt).toLocaleDateString()]})]})]}),(0,Zs.jsx)(ph,{src:null!==(t=o.profile)&&void 0!==t&&t.avatar?(e=>{if(!e)return"https://i.pravatar.cc/150?img=3";if(e.startsWith("http://")&&(e="https://"+e.substring(7)),e.startsWith("https://")||e.startsWith("blob:"))return e;const t=e.startsWith("/")?e:`/${e}`;return`${{NODE_ENV:"production",PUBLIC_URL:"",WDS_SOCKET_HOST:void 0,WDS_SOCKET_PATH:void 0,WDS_SOCKET_PORT:void 0,FAST_REFRESH:!0}.REACT_APP_API_URL||"https://api.jokesteronline.org"}${t}`})(o.profile.avatar):"https://i.pravatar.cc/150?img=3",alt:o.username,crossOrigin:"anonymous",onError:e=>{e.target.src="https://i.pravatar.cc/150?img=3",e.target.onerror=null}}),(0,Zs.jsxs)(hh,{children:[(0,Zs.jsxs)(mh,{to:`/users/${o._id}`,children:["@",o.username]}),(0,Zs.jsx)(gh,{children:(null===(r=o.profile)||void 0===r?void 0:r.bio)||"Sem biografia ainda..."})]}),i&&(0,Zs.jsx)(vh,{$isFollowing:a,onClick:()=>s(!a),children:a?"Seguindo":"Seguir"})]})},wh=Zn.div`
  margin-top: 20px;
`,kh=Zn.h3`
  margin-bottom: 15px;
  color: var(--text);
