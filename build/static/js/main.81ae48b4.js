/*! For license information please see main.81ae48b4.js.LICENSE.txt */
...
`,ye=Zr.div`
  ...
  color: var(--text-light);
  font-size: 0.9rem;
`;return(0,fl.jsxs)(ku,{"data-testid":"comment-section",style:{paddingBottom:me?"300px":"0",transition:"padding-bottom 0.3s ease"},"aria-live":"polite","aria-atomic":"true",children:[(0,fl.jsxs)(Zu,{"aria-live":"polite",children:[a.length," ",1===a.length?"coment\xe1rio":"coment\xe1rios"]}),c&&(0,fl.jsxs)(Ju,{role:"alert",children:[c,(0,fl.jsx)(ve,{onClick:Z,"aria-label":"Tentar carregar coment\xe1rios novamente",children:"Tentar novamente"})]}),(0,fl.jsx)(Su,{children:l?(0,fl.jsxs)(Qu,{"aria-busy":"true",children:[(0,fl.jsx)("div",{className:"spinner","aria-hidden":"true"}),"Carregando coment\xe1rios..."]}):Array.isArray(a)&&0!==a.length?(0,fl.jsxs)("div",{role:"list",children:[pe.map((e=>(0,fl.jsx)(bc,{comment:e,depth:0,currentUser:i,onEdit:ue,onDelete:de,onReply:ae,onReaction:fe,editingId:h,editText:g,onEditChange:v,onSaveEdit:ce,replyingTo:R,replyTexts:A,onReplyChange:se,onReplySubmit:le,showOptions:y,onToggleOptions:b,isPopular:e.isPopular||!1,onReplyMediaChange:te,onReplyMemeChange:ne,replyMedia:N,replySelectedMeme:z,onOpenMemeSelector:re,userMemes:S,loadMoreReplies:Q,loadingReplies:H,expandedReplies:F,setExpandedReplies:U},e._id))),he&&a.length>3&&(0,fl.jsx)(ye,{children:"Voc\xea chegou ao fim. Role para cima \u2191"})]}):(0,fl.jsxs)(Xu,{children:["Nenhum coment\xe1rio ainda. Seja o primeiro!",he&&(0,fl.jsx)("div",{style:{marginTop:"10px"},children:"Role para baixo para comentar \u2193"})]})}),i&&(0,fl.jsxs)(fl.Fragment,{children:[(0,fl.jsxs)(Lu,{onSubmit:ie,role:"form",children:[(0,fl.jsx)(Nu,{type:"text",id:"main-comment-input",name:"mainComment",value:f,onChange:e=>p(e.target.value),placeholder:"Escreva um coment\xe1rio...","aria-label":"Escrever coment\xe1rio","data-testid":"comment-input","aria-required":"true"}),(0,fl.jsxs)(oc,{children:[(0,fl.jsx)(ic,{type:"button",onClick:()=>document.getElementById("comment-file-input").click(),"aria-label":"Anexar m\xeddia","data-testid":"attach-media-button",children:(0,fl.jsx)(ql,{size:18,"aria-hidden":"true"})}),(0,fl.jsx)("input",{type:"file",id:"comment-file-input",style:{display:"none"},onChange:ee,accept:"image/*, video/*","data-testid":"media-input","aria-label":"Selecionar arquivo de m\xeddia"}),(0,fl.jsx)(ic,{type:"button",onClick:()=>{k(!0),G()},"aria-label":"Compartilhar meme","data-testid":"meme-selector-button",children:(0,fl.jsx)(Dl,{size:18,"aria-hidden":"true"})}),(0,fl.jsx)($u,{type:"submit","aria-label":"Enviar coment\xe1rio",disabled:!f.trim()&&!T&&!j,"data-testid":"submit-comment-button","aria-disabled":!f.trim()&&!T&&!j,children:(0,fl.jsx)(Ql,{size:18,"aria-hidden":"true"})})]}),(T||j)&&(0,fl.jsx)(yc,{file:T,meme:j?S.find((e=>e._id===j)):null,onRemove:()=>{O(null),C(null)},"data-testid":"media-preview"})]}),_&&(0,fl.jsx)(xc,{memes:S,selectedMeme:D?z[D]:j,onSelect:oe,onClose:()=>{k(!1),I(null)},isForReply:!!D,"data-testid":"meme-selector-modal"})]})]})},_c=(e,t,n)=>{if(!e)return null;return e.split(/(@\w+)/g).map(((e,r)=>{if(e.startsWith("@")){const o=e.substring(1),i=t[o];return i?(0,fl.jsx)("span",{className:"mention",onClick:e=>{e.preventDefault(),e.stopPropagation(),n(`/users/${i}`)},children:e},`${o}-${r}`):e}return e}))},kc=async e=>{if(!e)return[];const t=[...e.matchAll(/@([a-zA-Z0-9_]+)/g)],n=[...new Set(t.map((e=>e[1])))];if(0===n.length)return[];try{const e=await $a.post("/users/validate-mentions",{usernames:n}),t={};return e.data.validUsers.forEach((e=>{t[e.username]=e.userId})),{mentions:e.data.validUsers,mentionMap:t}}catch(r){return console.error("Error validating mentions:",r),{mentions:[],mentionMap:{}}}},Sc=to`
...
//# sourceMappingURL=main.81ae48b4.js.map