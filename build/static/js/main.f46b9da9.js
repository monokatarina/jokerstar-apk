/*! For license information please see main.f46b9da9.js.LICENSE.txt */
...
`,dm=e=>{let{memeId:t,onDelete:n}=e;const[o,i]=(0,r.useState)(!1);return(0,Gs.jsxs)("div",{style:{position:"relative"},children:[(0,Gs.jsx)(lm,{onClick:()=>i(!o),children:(0,Gs.jsx)($l,{size:14})}),o&&(0,Gs.jsx)(um,{children:(0,Gs.jsxs)(cm,{onClick:async()=>{try{await wa.delete(`/memes/${t}`),n(t)}catch(Uv){console.error("Erro ao deletar meme:",Uv)}i(!1)},children:[(0,Gs.jsx)(Fl,{}),(0,Gs.jsx)("span",{children:"Deletar"})]})})]})},fm=Zr(rt)`
  display: block;
  border-radius: 8px;
  overflow: hidden;
  position: relative;
