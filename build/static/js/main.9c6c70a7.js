/*! For license information please see main.9c6c70a7.js.LICENSE.txt */
...
`,Tp=()=>{const[e,t]=(0,n.useState)([]),[r,o]=(0,n.useState)(!0),[i,a]=(0,n.useState)(null),{user:s,logout:l}=tl(),u=te(),c=async()=>{try{o(!0),a(null);const{data:e}=await wa.get("/memes"),r=Array.isArray(null===e||void 0===e?void 0:e.data)?e.data.filter((e=>!e.isDeleted)):[];t(r)}catch(i){var e;console.error("Erro ao carregar feed:",i),a("Erro ao carregar o feed. Tente novamente mais tarde."),401===(null===(e=i.response)||void 0===e?void 0:e.status)&&(await l(),u("/login"))}finally{o(!1)}},d=e=>{t((t=>t.filter((t=>t._id!==e))))};return(0,n.useEffect)((()=>{c()}),[]),r?(0,Gs.jsx)(kp,{children:(0,Gs.jsx)(jp,{children:"Carregando..."})}):i?(0,Gs.jsx)(kp,{children:(0,Gs.jsxs)(Cp,{children:[i,(0,Gs.jsxs)("button",{onClick:c,children:[(0,Gs.jsx)(iu,{})," Tentar novamente"]})]})}):(0,Gs.jsx)(kp,{children:(0,Gs.jsx)(_p,{children:0===e.length?(0,Gs.jsxs)(Ep,{children:[(0,Gs.jsx)("h3",{children:"Nenhum meme encontrado"}),(0,Gs.jsx)("p",{children:"Seja o primeiro a compartilhar sua cria\xe7\xe3o!"}),(0,Gs.jsx)(Hf,{size:"large"})]}):e.map((e=>(0,Gs.jsx)(Sp,{children:(0,Gs.jsx)(Bf,{meme:e,onDelete:d,onCommentCountChange:r=>{t((t=>t.map((t=>t._id===e._id?{...t,commentCount:r}:t))))},isSquareView:!0,style:{width:"100%",height:"100%",borderRadius:"12px"}})},e._id)))})})},Op=Zn.div`
  position: relative;
  width: 100%;
`,Rp=Zn.textarea`
  width: 100%;
