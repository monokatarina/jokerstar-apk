...
`,Cp=Zn.small`
  ...
  color: #7f8c8d;
  font-size: 0.8rem;
`,Tp=()=>{const[e,t]=(0,n.useState)({username:"",email:"",password:""}),[r,o]=(0,n.useState)(""),[i,a]=(0,n.useState)(!1),s=te();return(0,Gs.jsx)(xp,{children:(0,Gs.jsxs)(wp,{children:[(0,Gs.jsx)(Ep,{children:"Crie sua conta"}),r&&(0,Gs.jsx)(Sp,{children:r}),(0,Gs.jsxs)("form",{onSubmit:async t=>{t.preventDefault(),a(!0),o("");try{const t=await ka(e);localStorage.setItem("token",t.token),s("/feed",{replace:!0})}catch(Wv){o("CONFLICT"===Wv.type?Wv.message:"Erro ao cadastrar. Por favor, tente novamente.")}finally{a(!1)}},children:[(0,Gs.jsx)(_p,{type:"text",placeholder:"Nome de usu\xe1rio",value:e.username,onChange:r=>t({...e,username:r.target.value}),required:!0,minLength:3}),(0,Gs.jsx)(_p,{type:"email",placeholder:"Email",value:e.email,onChange:r=>t({...e,email:r.target.value}),required:!0}),(0,Gs.jsx)(_p,{type:"password",placeholder:"Senha",value:e.password,onChange:r=>t({...e,password:r.target.value}),required:!0,minLength:6}),(0,Gs.jsx)(Cp,{children:"M\xednimo de 8 caracteres e numeros"}),(0,Gs.jsx)(kp,{type:"submit",disabled:i,children:i?"Cadastrando...":"Criar conta"})]}),(0,Gs.jsxs)(jp,{children:["J\xe1 tem conta? ",(0,Gs.jsx)(nt,{to:"/login",children:"Fa\xe7a login"})]})]})})},Op=Zn.div`
  width: 100%;
  height: 100vh;
  background-color: var(--background);
  overflow-x: auto;
...
`,Fv=Zn.div`
  ...
  width: 100%;
  z-index: 1000;
`;const Iv=function(){return(0,n.useEffect)((()=>{Capacitor.isNativePlatform()&&(ml.setOverlaysWebView({overlay:!0}),ml.setBackgroundColor({color:"#00000000"}),Zc.addListener("keyboardWillShow",(e=>{document.documentElement.style.setProperty("--keyboard-height",`${e.keyboardHeight}px`)})),Zc.addListener("keyboardWillHide",(()=>{document.documentElement.style.setProperty("--keyboard-height","0px")})))}),[]),(0,Gs.jsx)(el,{children:(0,Gs.jsx)(xl,{children:(0,Gs.jsx)(tt,{children:(0,Gs.jsxs)(vl,{children:[(0,Gs.jsx)(ro,{}),(0,Gs.jsxs)(zv,{children:[(0,Gs.jsx)(Fv,{children:(0,Gs.jsx)(Xc,{})}),(0,Gs.jsx)(Mv,{children:(0,Gs.jsxs)(xe,{children:[(0,Gs.jsx)(ye,{path:"/",element:(0,Gs.jsx)(dp,{})}),(0,Gs.jsx)(ye,{path:"/memes/:id",element:(0,Gs.jsx)(Nv,{})}),(0,Gs.jsx)(ye,{path:"/login",element:(0,Gs.jsx)(bp,{})}),(0,Gs.jsx)(ye,{path:"/register",element:(0,Gs.jsx)(Tp,{})}),(0,Gs.jsx)(ye,{path:"/users/:userId",element:(0,Gs.jsx)(eg,{})}),(0,Gs.jsx)(ye,{path:"/trending",element:(0,Gs.jsx)(cp,{})}),(0,Gs.jsx)(ye,{path:"/feed",element:(0,Gs.jsx)(Hl,{children:(0,Gs.jsx)(Np,{})})}),(0,Gs.jsx)(ye,{path:"/upload",element:(0,Gs.jsx)(Hl,{children:(0,Gs.jsx)(eh,{})})}),(0,Gs.jsx)(ye,{path:"*",element:(0,Gs.jsx)(ve,{to:"/"})})]})}),(0,Gs.jsx)(Dv,{})]})]})})})})},Uv=document.getElementById("root");(0,o.H)(Uv).render((0,Gs.jsx)(n.StrictMode,{children:(0,Gs.jsx)(Iv,{})}))})()})();
//# sourceMappingURL=main.41cfcaf5.js.map