/*! For license information please see main.83c7850d.js.LICENSE.txt */
...
`,Tp=()=>{const[e,t]=(0,n.useState)([]),[r,o]=(0,n.useState)(!0),[i,a]=(0,n.useState)(null),[s,l]=(0,n.useState)(0),u=(0,n.useRef)(null),{logout:c}=tl(),d=te(),f=(0,n.useRef)(0),p=(0,n.useRef)(0),h=async()=>{try{o(!0),a(null);const{data:e}=await wa.get("/memes"),r=Array.isArray(null===e||void 0===e?void 0:e.data)?e.data.filter((e=>!e.isDeleted)):[];t(r)}catch(i){var e;console.error("Erro ao carregar feed:",i),a("Erro ao carregar o feed. Tente novamente mais tarde."),401===(null===(e=i.response)||void 0===e?void 0:e.status)&&(await c(),d("/login"))}finally{o(!1)}},m=e=>{t((t=>t.filter((t=>t._id!==e))))},g=e=>{u.current&&u.current.scrollTo({left:e*window.innerWidth,behavior:"smooth"})};return(0,n.useEffect)((()=>{h()}),[]),r?(0,Gs.jsx)(kp,{ref:u,children:(0,Gs.jsx)(jp,{children:"Carregando..."})}):i?(0,Gs.jsx)(kp,{ref:u,children:(0,Gs.jsxs)(Cp,{children:[i,(0,Gs.jsxs)("button",{onClick:h,children:[(0,Gs.jsx)(iu,{})," Tentar novamente"]})]})}):(0,Gs.jsx)(kp,{ref:u,onTouchStart:e=>{f.current=e.touches[0].clientX},onTouchMove:e=>{p.current=e.touches[0].clientX},onTouchEnd:()=>{const t=f.current-p.current;if(t>50&&s<e.length-1){const e=s+1;l(e),g(e)}else if(t<-50&&s>0){const e=s-1;l(e),g(e)}else g(s)},children:(0,Gs.jsx)(_p,{children:0===e.length?(0,Gs.jsxs)(Ep,{children:[(0,Gs.jsx)("h3",{children:"Nenhum meme encontrado"}),(0,Gs.jsx)("p",{children:"Seja o primeiro a compartilhar sua cria\xe7\xe3o!"}),(0,Gs.jsx)(Hf,{size:"large"})]}):e.map(((e,r)=>(0,Gs.jsx)(Sp,{className:r===s?"active":"",children:(0,Gs.jsx)(Bf,{meme:e,onDelete:m,onCommentCountChange:r=>{t((t=>t.map((t=>t._id===e._id?{...t,commentCount:r}:t))))},isSquareView:!1,isActive:r===s,style:{width:"100%",height:"100%"}})},e._id)))})})},Op=Zn.div`
  position: relative;
  width: 100%;
`,Rp=Zn.textarea`
  width: 100%;
...
//# sourceMappingURL=main.83c7850d.js.map